...
## Table of Contents
- [Local Masking Meets Progressive Freezing: Efficient Vision Transformers](#local-masking-meets-progressive-freezing-efficient-vision-transformers)
  ...
  - [Re-produce Results](#re-produce-results)
    - [Dataset arrangement](#dataset-arrangement)
    - [Training and Evaluation](#training-and-evaluation)
        - [Details about the hyperparameters](#details-about-the-hyperparameters)
    - [Citation](#citation)
